...
brand: "DJI"
car: 
    - Sistema de transmisión OcuSync HD, que funciona en una frecuencia de banda dual y se conecta de forma inalámbrica a las DJI Goggles.
    - Sensor de 1 pulgada y 20 megapíxeles, capaz de grabar vídeos a 4K/60 fps y fotografiar en modo disparo en ráfaga a 14 fps.
    - Sistema Flight Autonomy incluye sensores dobles de visión trasera y sensores infrarrojos para un total de 5 direcciones de detección de obstáculos y un sistema anticolisión en 4 direcciones.
